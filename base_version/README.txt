...
set ...\base_version as the working directory, and enter the command: 

include("Quar_scenarios_main_newVE_b015_2021_10_21.jl")

The above will simulate the scenarios defined in "scenario_table_VEi36_VEs67_2021_10_21.csv"

to simulate the scenarios defined in "scenario_table_VEi36_VEs67_2021_10_08.csv"

enter the command: 

include("Quar_scenarios_main_newVE_b015_2021_10_08.jl").
