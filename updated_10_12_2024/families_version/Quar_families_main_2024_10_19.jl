...
global scenario_filename = "scenario_table_fam_2024_10_19.csv"
...
function main()
    ...
    include("./Quar_ABM_utils_2021_10_21.jl")
    include("./Agent_Quar.jl")
    include("./Quar_ABM_environment.jl")
    include("./Quar_ABM_disease_no_R0_b015.jl")
    include("./Quar_ABM_functions_2024_10_12.jl")

    date = "2024_10_19"

    output_dirname = pwd() * "/fam_split_scenarios_tf_2M/" * date *"/"
