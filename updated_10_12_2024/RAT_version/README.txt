...
set ...\RAT_version as the working directory, and enter the command: 

include("Quar_scenarios_main_RAT_b015_2021_10_14.jl")

The above will simulate the scenarios defined in "scenario_table_RAT_2021_10_14.csv"
...
NOTE: the code used for calibration of the model to RAT test sensitivity estimates is located in the \RAT_version\calibration folder. The files "RAT_test_sensitivity_vs_t.pdf" and "RAT_test_sensitivity_vs_tinc.pdf" demonstrate the distribution of test sensitivity trajectories for an ensemble of simulated individuals. These feature lower peak test sensitivities than those used for the PCR testing model described in the arXiv preprint listed above. 
